...
/*-----------------------------------------------------------*/
void
GibbonsMaeda_AB_To_XR (int nvar, CCTK_REAL A, CCTK_REAL B, CCTK_REAL *X, CCTK_REAL *R,
	  derivs U)
...
/*-----------------------------------------------------------*/
void
GibbonsMaeda_C_To_c (int nvar, CCTK_REAL X, CCTK_REAL R, CCTK_REAL *x, CCTK_REAL *r,
	derivs U)
...
/*-----------------------------------------------------------*/
void
GibbonsMaeda_rx3_To_xyz (int nvar, CCTK_REAL x, CCTK_REAL r, CCTK_REAL phi,
